...
class Observer:
    ...
    def __init__(self):
        ...
        # Выбранный танк (тег формата 'ussr:R04_T-34')
        self.selectedVehicleTag = 'sweden:S16_Kranvagn'
